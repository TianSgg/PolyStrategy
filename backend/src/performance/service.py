...
class PerformanceService:
    ...
    def _copy_trading_summary(self) -> dict:
        ...
        caches = [
            ...
            self._cache_block("copy_trading", "buy_debt", "BUY Debt",
                              self._nested_amount_items(service._buy_debt, "follower", "debt")),
            self._cache_block("copy_trading", "sell_debt", "SELL Debt",
                              self._nested_amount_items(service._sell_debt, "follower", "debt")),
    ...
    def _cache_items(self, service: str, cache: str, asset_id: Optional[str] = None) -> List[dict]:
        if service == "copy_trading":
            ...
            mapping = {
                ...
                "buy_debt": lambda: self._nested_amount_items(ct._buy_debt, "follower", "debt"),
                "sell_debt": lambda: self._nested_amount_items(ct._sell_debt, "follower", "debt"),
