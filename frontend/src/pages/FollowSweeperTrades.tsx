...
export default function FollowSweeperTrades({ darkMode, proxyWallet, onBack }: Props) {
            ...
            <div key={t.event_id}>
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '16px', fontSize: '12px', color: textSecondary, flexWrap: 'wrap', alignItems: 'center' }}>
                  {leaderWallet && <span style={{ color: '#8b5cf6', fontWeight: 500 }}>leader: {leaderWallet}...</span>}
